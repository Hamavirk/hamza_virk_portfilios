...
const Footer = () => {
  return (
    <footer className="bg-gradient-to-r from-gray-800 via-blue-900 to-gray-800 dark:from-black dark:via-gray-900 dark:to-black text-white animate-slide-up shadow-lg shadow-blue-500/10">
