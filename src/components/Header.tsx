...
const Header = () => {
  ...
  return (
    <header className="fixed top-0 left-0 right-0 z-50 bg-gradient-to-r from-gray-800 via-blue-900 to-gray-800 dark:from-black dark:via-gray-900 dark:to-black backdrop-blur-md border-b border-white/10 transition-all duration-300">
